...
{
    public sealed record CreateAssignmentRequest(string PositionId, string DepartmentId, string? ManagerId, DateTime HireDate, DateTime? TerminationDate, string StatusId, CreateAssignmentContractRequest Contract);
