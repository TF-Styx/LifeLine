namespace Shared.Contracts.Request.EmployeeService.Assignment
{
    ...
    public sealed record CreateManyDataAssignmentsReqeust(string PositionId, string DepartmentId, string BranchId, string? ManagerId, DateTime HireDate, DateTime? TerminationDate, string StatusId, CreateManyDataAssignmentContractReqeust Contracts);
