...
{
    public sealed class UpdateCorporateEmailCommandHandler
        (
            IWriteContext context,
            IEmployeeRepository repository,
            ILogger<UpdateCorporateEmailCommandHandler> logger
        ) : IRequestHandler<UpdateCorporateEmailCommand, Result>
    {
        private readonly IWriteContext _context = context;
        private readonly IEmployeeRepository _repository = repository;
        private readonly ILogger<UpdateCorporateEmailCommandHandler> _logger = logger;

        public async Task<Result> Handle(UpdateCorporateEmailCommand request, CancellationToken cancellationToken)
        {
            try
            {
