...
{
    public sealed class UpdateEmployeePatronymicCommandHandler
        (
            IWriteContext context,
            IEmployeeRepository repository,
            ILogger<UpdateEmployeePatronymicCommandHandler> logger
        ) : IRequestHandler<UpdateEmployeePatronymicCommand, Result>
    {
        private readonly IWriteContext _context = context;
        private readonly IEmployeeRepository _repository = repository;
        private readonly ILogger<UpdateEmployeePatronymicCommandHandler> _logger = logger;

        public async Task<Result> Handle(UpdateEmployeePatronymicCommand request, CancellationToken cancellationToken)
        {
            try
            {
