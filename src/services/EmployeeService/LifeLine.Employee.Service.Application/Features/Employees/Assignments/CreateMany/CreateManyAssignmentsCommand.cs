...
namespace LifeLine.Employee.Service.Application.Features.Employees.Assignments.CreateMany
{
    ...
    public sealed record CreateManyDataAssignmentsCommand(Guid PositionId, Guid DepartmentId, Guid BranchId, Guid? ManagerId, DateTime HireDate, DateTime? TerminationDate, Guid StatusId, CreateManyDataAssignmentContractCommand Contracts);
