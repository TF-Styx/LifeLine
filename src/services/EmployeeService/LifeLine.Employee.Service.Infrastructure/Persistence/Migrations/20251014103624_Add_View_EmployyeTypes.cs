...
{
    /// <inheritdoc />
    public partial class Add_View_EmployyeTypes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var resourceName = "LifeLine.Employee.Service.Infrastructure.Persistence.SQL.Views.V_EmployeeTypes.sql";
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"DROP VIEW IF EXISTS ""V_EmployeeTypes"";");
        }
    }
}
