...
{
    public sealed record ProgramEducationName
    {
        ...
        private ProgramEducationName(string value) { Value = value; }

        /// <exception cref="EmptyNameException"></exception>
        /// <exception cref="LengthException"></exception>
        public static ProgramEducationName Create(string value)
        {
            GuardException.Against.That(string.IsNullOrEmpty(value), () => new EmptyNameException($"В структуру {nameof(ProgramEducationName)} был передано пустое поле!"));
